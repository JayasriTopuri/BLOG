...
mydb=mysql.connector.connect(host='localhost',user='root',password='Jayasri@123',db='chinna')
with mysql.connector.connect(host='localhost',user='root',password='Jayasri@123',db='chinna'):
